...
class RosInterface:
    ...
    def front_callback_function(self, msg):
        self.cam_front_tensor_img = self.image_general_callback(msg, self.bridge, self.cam_front_tensor_img_lock,
                                                                tag="rgb_front")

    def left_callback_function(self, msg):
        self.cam_left_tensor_img = self.image_general_callback(msg, self.bridge, self.cam_left_tensor_img_lock,
                                                               tag="rgb_left")

    def right_callback_function(self, msg):
        self.cam_right_tensor_img = self.image_general_callback(msg, self.bridge, self.cam_right_tensor_img_lock,
                                                                tag="rgb_right")

    def back_callback_function(self, msg):
        self.cam_rear_tensor_img = self.image_general_callback(msg, self.bridge, self.cam_rear_tensor_img_lock,
                                                               tag="rgb_rear")
